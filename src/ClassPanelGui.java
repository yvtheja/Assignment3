...
public class ClassPanelGui extends JFrame {

    public ClassPanelGui () {
...
//        nodes.add(classJ);
        ...
        JPanel panel = new ClassPanelTest(nodes);
        ...
        for (int i = 0; i < nodes.size(); i ++) {
            ...
            JPanel rect = new ClassRectangleTest(p1, node.getNumberOfMethods(), node.getIfPresent(), node.getLoopPresent(), node.getClassName(), colors[i]);
//            ((ClassRectangleTest) rect).drawRectangle();
    ...
    public static void main (String[] args) {
        ...
        JFrame frame = new ClassPanelGui();
